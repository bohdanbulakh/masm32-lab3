...
.data
    ...
    BohdanBulakhWrongWindowText     db "This password is incorrect", 13, 10, "Try again", 0
...
BohdanBulakhValidatePassword proc
...
BohdanBulakhValidatePassword endp
   ...
   .if BohdanBulakhUnit == WM_COMMAND
		.if BohdanBulakhAction == IDOK
			invoke GetDlgItemText, BohdanBulakhWindowHandle, 1200, \
                    ...
                    call BohdanBulakhValidatePassword
			
                  invoke lstrcmp, offset BohdanBulakhUserPassword, \
                            offset BohdanBulahlDecryptedPassword
...
start:
	Dialog "Laboratory 3, encrypted", "Arial", 12, \
