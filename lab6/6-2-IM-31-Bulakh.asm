...
.data
	...
	BohdanBulakh0DivError	db "Помилка: ділення на 0", 0    
    	BohdanBulakhMessageBoxTitle            	db "Лабороаторна робота 6", 0
...
lab:
    ...
    addr BohdanBulakhCurrentStrC
     ...
     BohdanBulakhD[esi * 8], addr BohdanBulakhCurrentStrD
    	...
    	fld BohdanBulakhD[esi * 8]
    
    	fld BohdanBulakh82Const
    
    	fmul
    
    	fstp BohdanBulakhSecondMulDenom

    	fld BohdanBulakhMinus2Const
    
    	fld BohdanBulakhC[esi * 8]
